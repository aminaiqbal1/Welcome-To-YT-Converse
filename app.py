...
st.markdown("""
    ...
    <div class="text-strip">
        <p style="font-size:32px; font-weight:bold;">Welcome To YT Converse 💬  </p> <!-- Added the title -->
    </div>
    """, unsafe_allow_html=True)
# Set Streamlit page configuration
st.subheader("👥 Connect and converse over YouTube videos seamlessly ")
...
> ```{transcript}```"""),
    ...
    llm_chain = prompt | ChatGoogleGenerativeAI(model="gemini-1.5-flash",google_api_key=("WgCIW65Xs51TL4Vh6KJEgmw3VA78WbbypVlq7AI2"))
